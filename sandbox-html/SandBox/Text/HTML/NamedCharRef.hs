module SandBox.Text.HTML.NamedCharRef (
    charRefNameToMaybeString
  ) where
...
charRefNameToMaybeString :: String -> Maybe String
charRefNameToMaybeString name = M.lookup name namedCharRefMap

namedCharRefMap :: Map String String
namedCharRefMap = fromList
    [ ("AElig", "\x000C6")
    , ("AMP", "\x00026")
    , ("Aacute", "\x000C1")
    , ("Abreve", "\x00102")
